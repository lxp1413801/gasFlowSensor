...
# 13 "mcc_generated_files/../src/api/my_uart.h"
...
# 24 "mcc_generated_files/../src/globle/globle.h"
...
while(0 == _bEusartRxCount)
{
}

readValue = _bEusartRxBuffer[eusartRxTail++];
if(sizeof(_bEusartRxBuffer) <= eusartRxTail)
{
eusartRxTail = 0;
}
PIE1bits.RCIE = 0;
...
t8=RCREG;
if(_bEusartRxCount<160){
_bEusartRxBuffer[_bEusartRxCount]=t8;
_bEusartRxCount++;
eusartRxIdleTime_ms=10;
}
