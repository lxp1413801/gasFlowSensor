...
# 92 "src/api/../../mcc_generated_files/pin_manager.h"
...
# 76 "src/api/../../mcc_generated_files/eusart.h"
...
# 71 "src/api/../../mcc_generated_files/mcc.h"
...
# 13 "src/api/my_uart.h"
extern uint8_t eusartTxBuffer[16];
extern volatile uint8_t eusartTxLen;
extern volatile uint16_t eusartRxIdleTime_ms;

extern volatile uint8_t _bEusartRxBuffer[160];
...
# 5 "src/api/my_uart.c"
uint8_t eusartTxBuffer[16];
volatile uint8_t eusartTxLen=0;
volatile uint16_t eusartRxIdleTime_ms=0;

volatile uint8_t _bEusartRxBuffer[160];
...
TXREG = *str;
str++;
do{__nop();__nop();__nop();__nop();__nop();__nop();__nop();__nop();__nop();}while(0);;
}
while(0 == PIR1bits.TXIF);
}
