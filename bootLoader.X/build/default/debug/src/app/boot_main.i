...
# 92 "src/app/../../mcc_generated_files/pin_manager.h"
...
# 76 "src/app/../../mcc_generated_files/eusart.h"
...
# 71 "src/app/../../mcc_generated_files/mcc.h"
...
__nop();
do{ (INTCONbits.GIE = 0); (INTCONbits.PEIE = 0); }while(0);;
asm("pagesel 0x800");
asm("goto 0x800");
}
