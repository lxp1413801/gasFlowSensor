...
if(tempAddr>0x0f && tempAddr < 0x10+30*2){
tempAddr-=0x10;
if(tempAddr & 0x01){
...
fiSave=1;
}else if(startAddr>0x0f && startAddr < 0x10+30*2){
startAddr-=0x10;
if(startAddr & 0x01){
t16=rbuf[4];
t16<<=8;
...
# 251
default:
modbus_response_illgeal_function(rbuf,0x01);break;
}
}
