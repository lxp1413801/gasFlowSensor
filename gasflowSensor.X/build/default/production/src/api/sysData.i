...
# 16
FLASH_EraseBlock(0x1f00);
FLASH_EraseBlock(0x1f00+32);
FLASH_EraseBlock(0x1f00+64);
FLASH_EraseBlock(0x1f00+96);
FLASH_EraseBlock(0x1f00+128);
}

void my_flash_system_read(uint8_t* buf,uint16_t len)
{
uint16_t flashAddr=0x1f00;
uint16_t i;
